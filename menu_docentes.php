	...
	<div class="container">
		...
		<div class="header">
			<div class="contenedor_grid_header">
				...
				<div>
					<h3>
						<a class="tipo_texto selected" href="menu_docentes.php">Docentes</a>
					</h3>	
				</div>
				<div>
					<h3>
		...
		<div class="nav">
			<ul>
				<li>
					<a class="tipo_texto" href="#">Registrar</a>
				</li>

				<li>
					<a class="tipo_texto" href="#">Lista</a>
				</li>

				<li>
					<a class="tipo_texto" href="#">Asistencia</a>
				</li>

				<li>
					<a class="tipo_texto" href="#">Licencias</a>
				</li>
                
				<li>
					<a class="tipo_texto" href="#">Bajas</a>
				</li>
			</ul>			
		</div>
